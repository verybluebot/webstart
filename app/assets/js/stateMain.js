...
var StateMain = {
  ...
  setLisetners: function setLisetners() {
    game.time.events.loop(Phaser.Timer.SECOND, this.fireCandy, this);
  },

  resetThink: function resetThink() {
    var selectedCandy = game.rnd.integerInRange(0, 7);
  ...
  fireCandy: function fireCandy() {
    var candy = this.candies.getFirstDead();
    var yy = game.rnd.integerInRange(0, game.height - 90);
